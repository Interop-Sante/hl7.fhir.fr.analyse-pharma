# code system Interop'Santé - Codes pour le périmètre des notes - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/CodeSystem/fr-note-scope-codes | *Version*:0.1.0 |
| Draft as of 2026-05-22 | *Computable Name*:FrNoteScopeCodes |
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/CodeSystem/fr-note-scope-codes",
  "version" : "0.1.0",
