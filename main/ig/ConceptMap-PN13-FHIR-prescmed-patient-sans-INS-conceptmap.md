# Conversion PN13 vers FHIR pour un patient sans INS qualifiée d'une prescription de médicaments - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-prescmed-patient-sans-INS-conceptmap | *Version*:0.1.0 |
| Draft as of 2026-05-22 | *Computable Name*:FrPN13FHIRMedicationPrescriptionPatientSansINSConceptMap |
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-prescmed-patient-sans-INS-conceptmap",
  "version" : "0.1.0",
