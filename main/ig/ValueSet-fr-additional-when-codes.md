# value set Interop'Santé - Codes additionnels pour l'élément when - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ValueSet/fr-additional-when-codes | *Version*:0.1.0 |
| Draft as of 2026-05-22 | *Computable Name*:FrAdditionalWhenCodes |
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/ValueSet/fr-additional-when-codes",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://hl7.fr/ig/fhir/analyse-pharma/CodeSystem/fr-additional-when-codes"
    }]
  }
}
