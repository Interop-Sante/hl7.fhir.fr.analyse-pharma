# Conversion PN13 vers FHIR pour le patient d'une prescription de médicaments avec uniquement un identifiant fourni - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-prescmed-patient-id-seul-conceptmap | *Version*:0.1.0 |
| Draft as of 2026-05-22 | *Computable Name*:FrPN13FHIRMedicationPrescriptionPatientIdSeulConceptMap |
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-prescmed-patient-id-seul-conceptmap",
  "version" : "0.1.0",
