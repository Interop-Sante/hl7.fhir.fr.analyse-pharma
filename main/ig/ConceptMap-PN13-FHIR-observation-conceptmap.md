# Conversion PN13 vers FHIR pour les renseignements complémentaires d'une prescription de médicaments - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-observation-conceptmap | *Version*:0.1.0 |
| Draft as of 2026-05-26 | *Computable Name*:FrPN13FHIRObservationConceptMap |
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-observation-conceptmap",
  "version" : "0.1.0",
