# Validation pharmaceutique PN13 et intervention liée - Guide d'implémentation de l'analyse pharmaceutique v0.1.0-ballot

* [**Table of Contents**](toc.md)
* **Validation pharmaceutique PN13 et intervention liée**

## Validation pharmaceutique PN13 et intervention liée

### Exemple PN13 de validation pharmaceutique et intervention pharmaceutique liée

Cette validation PN13 est traduite en FHIR dans les instances [Analyse-Validation-Proposition-Trad-PN13-FHIR](Task-Analyse-Validation-Proposition-Trad-PN13-FHIR.md) et [Analyse-Validation-Intervention-Liee-Trad-PN13-FHIR](Task-Analyse-Validation-Intervention-Liee-Trad-PN13-FHIR.md)
