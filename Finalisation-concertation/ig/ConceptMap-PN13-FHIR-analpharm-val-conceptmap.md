# Conversion PN13 vers FHIR pour le résultat d'une analyse pharmaceutiquede type validation - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-analpharm-val-conceptmap | *Version*:0.1.0 |
| Draft as of 2026-05-21 | *Computable Name*:FrPN13FHIRPharmaceuticalAnalysisValidationConceptMap |
