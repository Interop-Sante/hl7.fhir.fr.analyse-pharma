# FR Prescription Bundle For Example - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| Draft as of 2026-05-21 | *Computable Name*:FRPrescriptionBundleForExample |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.analyse-pharma|current/StructureDefinition/fr-prescription-bundle-for-example)
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/StructureDefinition/fr-prescription-bundle-for-example",
  "version" : "0.1.0",
