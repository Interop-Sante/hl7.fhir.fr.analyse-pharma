# value set Interop'Santé - Codes pour le périmètre des notes - Guide d'implémentation de l'analyse pharmaceutique v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ValueSet/fr-note-scope-codes-vs | *Version*:0.1.0 |
| Draft as of 2026-05-21 | *Computable Name*:FrNoteScopeCodeValueSet |
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/ValueSet/fr-note-scope-codes-vs",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://hl7.fr/ig/fhir/analyse-pharma/CodeSystem/fr-note-scope-codes"
    }]
  }
}
