...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Medication/f:ingredient">
      <sch:assert test="count(f:extension[@url = 'https://hl7.fr/ig/fhir/analyse-pharma/StructureDefinition/fr-is-vehicle']) &lt;= 1">extension with URL = 'https://hl7.fr/ig/fhir/analyse-pharma/StructureDefinition/fr-is-vehicle': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
